...
Куда все это движется. Основные результаты:
  ...
  * ИТ-деньги и популярность нейросетей возникли одновременно, когда вычисления стали рыночной ценностью. Экономика из золотовалютной становится **золото-валютно-вычислительной**. Свою статью по [эконофизике](https://ru.wikipedia.org/wiki/%D0%AD%D0%BA%D0%BE%D0%BD%D0%BE%D1%84%D0%B8%D0%B7%D0%B8%D0%BA%D0%B0) и причине появления IT-денег опубликую в следующей статье.
...
Однако не появилось **«теории нейросетей»**, в рамках которой можно думать и работать системно. Что сейчас называется «теорией» на самом деле экспериментальные, эвристические алгоритмы.
